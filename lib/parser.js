...
module.exports.preParser = {
  ...
  async prepare(knexConnection) {
    ...
    lc.trackcontainer = lc.trackcontainer.filter((trackNameIn) =>
      !existingTrackNames.some((existingTrackName) => existingTrackName === trackNameIn.name));
